...
\section{Observation tables, Error Analysis}
% 1
...
\begin{gather*}
    \mathrm{ Average \ coefficient \ of \ restitution }= \bar{e} = \frac{\sum^{n}_{i=1}e_i} {n} = 0.6173 \\
    \mathrm{ Average \ least \ count \ of \ g} = \bar{\Delta g} = 0.0006 \\
    \mathrm{ Average \ acceleration \ due \ to \ gravity} = \bar{g} = \frac{\sum^{n}_{i=1}g_i} {n} = 9.7179 \pm 0.0006 \ m/s^2 \\
    \mathrm{Acceleration \ due \ to \ gravity \ as \ measured \ by \ PhyPhox} = g(correct) = 9.75 \ m/s^2
\end{gather*}
...
\begin{gather*}
    \mathrm{ Average \ coefficient \ of \ restitution } = \bar{e} = \frac{\sum^{n}_{i=1}e_i} {n} = 0.586 \\
    \mathrm{ Average \ least \ count \ of \ g} = \bar{\Delta g} = 0.0017 \\
    \mathrm{ Average \ acceleration \ due \ to \ gravity} = \bar{g} = \frac{\sum^{n}_{i=1}g_i} {n} = 9.75 \pm 0.0017\ m/s^2 \\
    \mathrm{Acceleration \ due \ to \ gravity \ as \ measured \ by \ PhyPhox} = g(correct) = 9.80 \ m/s^2
\end{gather*}
...
\begin{gather*}
    \mathrm{Average \ coefficient \ of \ restitution} = \bar{e} = \frac{\sum^{n}_{i=1}e_i} {n} = 0.57 \\
    \mathrm{ Average \ least \ count \ of \ g} = \bar{\Delta g} = 0.0014 \\
    \mathrm{Average \ acceleration \ due \ to \ gravity} = \bar{g} = \frac{\sum^{n}_{i=1}g_i} {n} = 9.72 \pm 0.0014 \ m/s^2 \\
    \mathrm{Acceleration \ due \ to \ gravity \ as \ measured \ by \ PhyPhox} = g(correct) = 9.77 \ m/s^2
\end{gather*}
...
\begin{gather*}
    \mathrm{Average \ coefficient \ of \ restitution} = \bar{e} = \frac{\sum^{n}_{i=1}e_i} {n} = 0.6316 \\
    \mathrm{ Average \ least \ count \ of \ g} = \bar{\Delta g} = 0.883 \\
    \mathrm{Average \ acceleration \ due \ to \ gravity} = \bar{g} = \frac{\sum^{n}_{i=1}g_i} {n} = 9.604 \pm 0.883 \ m/s^2 \\
    \mathrm{Acceleration \ due \ to \ gravity \ as \ measured \ by \ PhyPhox} = g(correct) = 9.67 \ m/s^2
\end{gather*}
...
\begin{gather*}
    \mathrm{Average \ coefficient \ of \ restitution} = \bar{e} = \frac{\sum^{n}_{i=1}e_i} {n} = 0.55 \\
    \mathrm{ Average \ least \ count \ of \ g} = \bar{\Delta g} = 0.024 \\
    \mathrm{Average \ acceleration \ due \ to \ gravity} = \bar{g} = \frac{\sum^{n}_{i=1}g_i} {n} = 9.22 \pm 0.024 \ m/s^2 \\
    \mathrm{Acceleration \ due \ to \ gravity \ as \ measured \ by \ PhyPhox} = g(correct) = 9.34 \ m/s^2
\end{gather*}
